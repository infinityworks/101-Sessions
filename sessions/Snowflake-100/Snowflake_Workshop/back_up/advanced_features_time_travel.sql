...
select distinct O_ORDERPRIORITY from orders_3_day at(statement => '01aad4ee-0000-50fd-0000-f42900062082');


-- not exist query approach. Use the first query id
select * from orders_3_day before(statement => '01aad4ee-0000-50fd-0000-f42900062082') tt_past
where not exists
(select 1
...
-- Exercise
-- We have an itme table that shows the current price for each item. Price history is not stored.
...
create or replace table item_price (
item_id int,
price FLOAT,
updated_at timestamp
);

insert into item_price (item_id, price, updated_at) values(1, 9.99, current_timestamp),(2, 4.99, current_timestamp);
...
-- start here
select * from item_price at(statement => '01aad519-0000-515c-0000-f4290005e2fa')
union all
select * from item_price at(statement => '01aad519-0000-515f-0000-f4290005d35a')
union all
select * from item_price at(statement => '01aad519-0000-515f-0000-f4290005d362')
union all
select * from item_price at(statement => '01aad519-0000-515e-0000-f42900060392')
